...
export function RegistryPanel() {
  ...
  // Corp is fully registered when someone else holds the claim AND a vault already exists.
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      <div className="card">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "6px", fontSize: "12px" }}>
          <div style={{ display: "flex", gap: "8px" }}>
            <span style={{ color: "#555", width: "110px" }}>Tribe ID</span>
            <span style={{ color: "#ffa032" }}>{tribeId ?? "—"}</span>
          </div>
          <div style={{ display: "flex", gap: "8px" }}>
            <span style={{ color: "#555", width: "110px" }}>Character</span>
            <span style={{ fontFamily: "monospace", color: "#888" }}>{shortAddr(characterId ?? "")}</span>
          </div>
          <div style={{ display: "flex", gap: "8px" }}>
            <span style={{ color: "#555", width: "110px" }}>Corp status</span>
          ...
          {claimExists && (
            <div style={{ display: "flex", gap: "8px" }}>
              <span style={{ color: "#555", width: "110px" }}>Founder</span>
      ...
      {/* ── Claim actions — hidden when corp is already registered by another wallet ── */}
        ...
        <div className="card">
          ...
          {claimExists && (
            <div style={{ fontSize: "12px", marginBottom: "10px", display: "flex", flexDirection: "column", gap: "4px" }}>
              ...
              <div style={{ display: "flex", gap: "8px" }}>
                <span style={{ color: "#555", width: "100px" }}>Vault</span>
