...
// node_modules/@mysten/dapp-kit-core/node_modules/@mysten/wallet-standard/dist/features/suiSignTransactionBlock.mjs
var SuiSignTransactionBlock = "sui:signTransactionBlock";

// node_modules/@mysten/dapp-kit-core/node_modules/@mysten/wallet-standard/dist/features/suiSignTransaction.mjs
var SuiSignTransaction = "sui:signTransaction";

// node_modules/@mysten/dapp-kit-core/node_modules/@mysten/wallet-standard/dist/features/suiSignAndExecuteTransactionBlock.mjs
var SuiSignAndExecuteTransactionBlock = "sui:signAndExecuteTransactionBlock";

// node_modules/@mysten/dapp-kit-core/node_modules/@mysten/wallet-standard/dist/features/suiSignAndExecuteTransaction.mjs
var SuiSignAndExecuteTransaction = "sui:signAndExecuteTransaction";

// node_modules/@mysten/dapp-kit-core/node_modules/@mysten/wallet-standard/dist/features/suiSignPersonalMessage.mjs
...
var CoreClient = class extends BaseClient {
  constructor(options) {
    ...
    this.mvr = new MvrClient({
      ...
      url: ((_a10 = options.mvr) == null ? void 0 : _a10.url) ?? DEFAULT_MVR_URLS[this.network],
...
function parseTransactionEffectsV2({ bytes, effects }) {
  const changedObjects = effects.changedObjects.map(([id, change]) => {
    ...
    return {
      ...
      inputVersion: ((_a10 = change.inputState.Exist) == null ? void 0 : _a10[0][0]) ?? null,
  ...
  constructor(ORDER, opts = {}) {
    ...
    if (opts != null && typeof opts === "object") {
      ...
      if (opts.allowedLengths)
        this._lengths = (_a10 = opts.allowedLengths) == null ? void 0 : _a10.slice();
...
var _a2;
var Ed25519PublicKey = (_a2 = class extends PublicKey {
  /**
...
var _a3;
var PasskeyPublicKey = (_a3 = class extends PublicKey {
  /**
...
var ZkLoginPublicIdentifier = (_a4 = class extends PublicKey {
  /**
...
var _a5;
var Secp256k1PublicKey = (_a5 = class extends PublicKey {
  /**
...
}, _a6.SIZE = SECP256R1_PUBLIC_KEY_SIZE, _a6);

// node_modules/@mysten/sui/dist/multisig/signer.mjs
var _pubkey, _signers, _a7;
var MultiSigSigner = (_a7 = class extends Signer {
  constructor(pubkey, signers = []) {
    ...
    for (const signer of signers) {
      ...
      const weight = (_a10 = weights.find((w) => w.address === address)) == null ? void 0 : _a10.weight;
...
}, _pubkey = new WeakMap(), _signers = new WeakMap(), _a7);
  ...
  */
  combinePartialSignatures(signatures) {
    ...
    for (let i = 0; i < signatures.length; i++) {
      ...
      let publicKey;
      if (parsed.signatureScheme === "ZkLogin") publicKey = toZkLoginPublicIdentifier((_a10 = parsed.zkLogin) == null ? void 0 : _a10.addressSeed, (_b = parsed.zkLogin) == null ? void 0 : _b.iss, { legacyAddress: false }).toRawBytes();
...
async function getSupportedIntentsFromFeature(wallet) {
  ...
  return ((_b = await ((_a10 = getWalletFeature(wallet, "sui:getCapabilities")) == null ? void 0 : _a10.getCapabilities())) == null ? void 0 : _b.supportedIntents) ?? [];
}
...
function signAndExecuteTransactionCreator({ $connection, $currentClient }) {
  return async function signAndExecuteTransaction2({ transaction, ...standardArgs }) {
...
function signTransactionCreator({ $connection, $currentClient }) {
  return async function signTransaction2({ transaction, ...standardArgs }) {
    const { account, supportedIntents } = $connection.get();
    if (!account) throw new WalletNotConnectedError("No wallet is connected.");
    const underlyingAccount = getWalletAccountForUiWalletAccount_DO_NOT_USE_OR_YOU_WILL_BE_FIRED(account);
    const suiClient = $currentClient.get();
...
function getDefaultAppName() {
  var _a10;
  return ((_a10 = document.querySelector(`meta[name="application-name"]`)) == null ? void 0 : _a10.content) || document.title;
}
...
var _chainConfig, _keypair, _account, _on, _connect, _signPersonalMessage, _signTransaction, _signAndExecuteTransaction, _a8;
var UnsafeBurnerWallet = (_a8 = class {
  constructor({ clients }) {
...
}, _chainConfig = new WeakMap(), _keypair = new WeakMap(), _account = new WeakMap(), _on = new WeakMap(), _connect = new WeakMap(), _signPersonalMessage = new WeakMap(), _signTransaction = new WeakMap(), _signAndExecuteTransaction = new WeakMap(), _a8);
...
var _publicKeyCache, _dAppKit, _a9;
var CurrentAccountSigner = (_a9 = class extends Signer {
  constructor(dAppKit) {
    super();
...
}, _publicKeyCache = new WeakMap(), _dAppKit = new WeakMap(), _a9);
...
*/
//# sourceMappingURL=chunk-VH6XZALG.js.map
